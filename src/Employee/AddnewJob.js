          ...
          <form>
             <div class="form-row pt-4">
                ...
                <div class="form-group col-md-5 px-3">
                   ...
                   <textarea class="form-control" aria-label="With textarea" placeholder="Special Note"></textarea>
                </div>
                <div class="form-group col-md-5 px-3">
                   <label for="exampleInputEmail1">Start Date</label>
                   <input type="date" class="form-control datepicker" id="exampleInputtext"  placeholder="Start Date" />                      
                </div>
                <div class="form-group col-md-5 px-3">
                   <label for="exampleInputlocation">Start Time</label>
                   <input type="time" class="form-control" id="exampleInputlocation" placeholder="Start Time" />
                </div>
                <div class="form-group col-md-5 px-3">
